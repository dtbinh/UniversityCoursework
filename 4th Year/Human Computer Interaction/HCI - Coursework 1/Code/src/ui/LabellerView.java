...
class LabellerView extends JFrame {
	...
	LabellerView(GalleryView gallery_view, EditorView editor_view){
	...
	String nameQuery(String inputname) {
	...
	String nameQuery(String inputname, String warning) {
	...
	int deleteQuery(String regionName){
	...
	Color colorQuery(Color oldColor){
