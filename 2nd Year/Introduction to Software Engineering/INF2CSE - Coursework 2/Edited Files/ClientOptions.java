...
public class ClientOptions extends OptionMap {
    ...
    /**
     * Option for end of turn sound
     */
    
    public static final String ENDOFTURN_ALERT = "model.option.turnAlert";
    
    public static final String REPORT_ALERT = "model.option.reportAlert";
    ...
    /**
     * Option for setting wether or not the  of war should be displayed.
     */
    ...
    protected void addDefaultOptions() {
        ...
        //Adds Boolean TurnAlert and Report Alert to Option Menu
