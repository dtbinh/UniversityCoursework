...
goal(S) :- cleaned(r4,S), cleaned(r6,S), cleaned(r7,S), dusterpos(d,r1,S), position(r1,S).		

%For answer to the question of the order mattering, please see the file "answers.txt"
% ---------------------------------------------------------------------
% ---------------------------------------------------------------------
