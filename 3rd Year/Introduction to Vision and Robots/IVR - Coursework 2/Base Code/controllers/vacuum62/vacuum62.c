...
//the robot is about to collide with an obstacle
  return (wb_distance_sensor_get_value(dist_sensors[DIST_SENSOR_FORWARD_1]) < 225 ||
          wb_distance_sensor_get_value(dist_sensors[DIST_SENSOR_FORWARD_2]) < 225 ||
          wb_distance_sensor_get_value(dist_sensors[DIST_SENSOR_FORWARD_3]) < 220 ||
          wb_distance_sensor_get_value(dist_sensors[DIST_SENSOR_FORWARD_4]) < 225 ||
          wb_distance_sensor_get_value(dist_sensors[DIST_SENSOR_FORWARD_5]) < 225);
  }
