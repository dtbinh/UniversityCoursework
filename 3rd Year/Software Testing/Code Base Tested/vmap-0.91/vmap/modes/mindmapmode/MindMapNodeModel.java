 ...
 */
/*$Id: MindMapNodeModel.java,v 1.12 2005/04/16 16:48:39 veghead Exp $ */
...
public class MindMapNodeModel extends NodeAdapter {
    ...
    /*
        public MindMapNodeModel( Object userObject, VmapMain frame ) {
    ...
    */
    ...
    public void save(Writer writer, MindMapMapModel model,
        ...
        if (isRoot()) {
            ...
            vmapMeta.setAttribute("text",this.getTitle());
            if (!(this.getAttach().equals(""))) {
                ...
                if ((attach.getParent() != null) && (attach.getParent().equals(xmlFile.getParent()))) {
                    ...
                    vmapMeta.setAttribute("attach",attach.getName());
                } else {
                    vmapMeta.setAttribute("attach",getAttach());
                }
