...
public class ControlGUI implements ChangeListener {
    ...
    /* Vision debug buttons */
    JCheckBox yellowExtrema;
    JCheckBox blueExtrema;
    JCheckBox blueTriple;
    JCheckBox yellowTriple;
    JCheckBox yAngleDisplay;
    JCheckBox bAngleDisplay;
    JCheckBox twoGreenDisplay;
    JCheckBox bounding;
    JCheckBox altComputer;
    JButton takeBackground;
    /* Ball sliders. */
    ...
    public void initGUI() {
        ...
        tabPane.addTab("Vision Tab", visionPanel);
    ...
    /*
     * Sets the Panel for Visual Debugging
     */
    private void setUpVisual() {

        /* Blue and Yellow Extrema Buttons */
        ...
        blueExtrema.addItemListener(
                new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        worldState.setBlueExtrema(blueExtrema.isSelected());
                    }
                });
        yellowExtrema.addItemListener(
                new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        worldState.setYellowExtrema(yellowExtrema.isSelected());
                    }
                });

        /* Colour choice */
        blueTriple = new JCheckBox("Show Blue Front/Mid/Back", false);
        yellowTriple = new JCheckBox("Show Yellow Front/Mid/Back", false);

        blueTriple.addItemListener(
                new ItemListener() {

                    public void itemStateChanged(ItemEvent e) {
                        worldState.setBlueTriple(blueTriple.isSelected());
                    }
                });
        yellowTriple.addItemListener(
                new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        worldState.setYellowTriple(yellowTriple.isSelected());
                    }
                });

        /* Direction choice */
        bAngleDisplay = new JCheckBox("Show Blue Angle", false);
        yAngleDisplay = new JCheckBox("Show Yellow Angle", false);

        bAngleDisplay.addItemListener(
                new ItemListener() {

                    public void itemStateChanged(ItemEvent e) {
                        worldState.setBAngle(bAngleDisplay.isSelected());
                    }
                });
        yAngleDisplay.addItemListener(
                new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        worldState.setYAngle(yAngleDisplay.isSelected());
                    }
                });

        /*Whether two green robots are on the pitch or not */
        twoGreenDisplay = new JCheckBox("Two Green on Pitch", true);
        twoGreenDisplay.addItemListener(
                new ItemListener() {

                    public void itemStateChanged(ItemEvent e) {
                        worldState.setDetectTwo(twoGreenDisplay.isSelected());
                    }
                });
         ...
         * 
         */
        /*Whether two display the bounding boxes around the robot*/
        bounding = new JCheckBox("Show Bounding Box", false);
        bounding.addItemListener(
                new ItemListener() {

                    public void itemStateChanged(ItemEvent e) {
                        worldState.setBounding(bounding.isSelected());
                    }
                });

        /*Whether we are on a computer that requires channel 0 or 2 */
        altComputer = new JCheckBox("Working on non-wall computer", false);
        altComputer.addItemListener(
                new ItemListener() {

                    public void itemStateChanged(ItemEvent e) {
                        worldState.setAlternateVision(altComputer.isSelected());
                    }
                });

        takeBackground = new JButton("Take background photo");
        takeBackground.addActionListener(new ActionListener() {

            /* Attempt to save an image of the pitch 
             * which will be used as the background.
             * Note: We may want to use multiple frames for this,
        ...
        /* 
         * Add everything to the vision Panel
         */
        ...
        visionPanel.add(altComputer);
        visionPanel.add(takeBackground);
