...
public class WorldState implements computer.simulator.VisionInterface {
    ...
    public void setAlternateVision(boolean alternate) {
        this.popcomputers = alternate;
    }

    public boolean getAlternateVision() {
        return popcomputers;
    }
    
    public void setBackground(boolean background) {
        this.takePicture = background;
    }
